...
the STM32CUBEIDE Eclipse based IDE.

Modified from the SW4STM32 exporter by : Keith Bryer <keith@innovodesign/co.uk>
...
class STM32CubeIde(GNUARMEclipse):
    """
    STM32CubeIde class
    """
    NAME = 'STM32CubeIde'
    ...
    def generate(self):
        ...
        print('\nCreate a ST32CubeIde managed project')
        ...
        self.gen_file('stm32cubeide/language_settings_commom.tmpl',
                      ctx, '.settings/language.settings.xml')
        self.gen_file('stm32cubeide/project_common.tmpl', ctx, '.project')
        self.gen_file('stm32cubeide/cproject_common.tmpl', ctx, '.cproject')
        self.gen_file('stm32cubeide/makefile.targets.tmpl', ctx,
                      'makefile.targets', trim_blocks=True, lstrip_blocks=True)
        self.gen_file('stm32cubeide/launch.tmpl', ctx, self.project_name +
